...
### Portfolio Template - From Design to Code Excellence
...
![Zero Dependencies](https://img.shields.io/badge/PRODUCTION_DEPS-0-FF6B6B?style=for-the-badge&logo=npm&logoColor=white)
![Bundle Size](https://img.shields.io/badge/BUNDLE-~15KB-9B59B6?style=for-the-badge&logo=webpack&logoColor=white)
...
| • [**Jornada de Desenvolvimento**](#-jornada-de-desenvolvimento) | Do Framer ao código: decisões técnicas e arquiteturais |
...
| • [**Arquitetura**](#️-arquitetura)                              | Estrutura de pastas e organização modular              |
| • [**Scripts Customizados**](#-scripts-customizados)             | Detalhamento dos 7 módulos JavaScript                  |
| • [**Animações GSAP**](#-animações-gsap)                         | Implementação de motion design profissional            |
| • [**Galeria**](#-galeria)                                       | Screenshots e demonstrações visuais                    |
...
**NORDIC** é um template de portfólio minimalista e profissional que nasceu de uma jornada única: **começou como um design no Framer e evoluiu para código puro com animações GSAP de nível profissional**.

### 💡 Conceito

O projeto foi criado com três pilares fundamentais:
